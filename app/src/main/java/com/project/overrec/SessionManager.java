...
import com.project.overrec.Activity.FileSelectionDialog;
import com.project.overrec.Codec.WaveReader;
import com.project.overrec.CustomView.AudioWaves;
import com.project.overrec.CustomView.Beatsline;
import com.project.overrec.CustomView.MetrnomeVisualizer;
import com.project.overrec.CustomView.SavesListView;
import com.project.overrec.CustomView.Timeline;
import com.project.overrec.Save.Savable;
import com.project.overrec.Save.TrackSave;
import com.project.overrec.Util.CustomToast;
import com.project.overrec.Util.SupportMath;
...
public class SessionManager implements NamedSession {
    ...
    public com.project.overrec.Track track;
    ...
    public SessionManager(final Activity context, final int sampleRate, int bufferSize, int audio_encoding, int audio_channel_in, int audio_channel_out) {
        ...
        track = new com.project.overrec.Track(sampleRate, bufferSize, audio_encoding, audio_channel_out);
        ...
        track.setTrackListener(new com.project.overrec.Track.TrackListener() {
            @Override
